...
"SELECT Projects.title, =-SUM(Projects.funding_goal, Pledges.amount) FROM Projects  
...
def selects_the_category_names_and_pledge_amounts_of_all_pledges_in_the_music_category  #OK 
    "
